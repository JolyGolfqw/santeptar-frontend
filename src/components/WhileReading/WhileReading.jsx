      ...
      <div className={styles.card}>
        ...
        <div className={styles.descWrapper}>
          ...
          <div className={styles.description}>
            «Книжный вор» стал издательской сенсацией. Его тираж только на
            английском языке превысил 1,5 миллиона экземпляров. Роман уже
            несколько лет находится в Top-30 рейтинга крупнейшего в мире
